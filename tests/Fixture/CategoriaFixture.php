...
class CategoriaFixture extends TestFixture
{
    ...
    public $fields = [
        'Id_cat' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'autoIncrement' => true, 'precision' => null],
        ...
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['Id_cat'], 'length' => []],
            'nombre_cat' => ['type' => 'unique', 'columns' => ['Nombre'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
